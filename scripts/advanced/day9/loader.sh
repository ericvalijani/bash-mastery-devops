...
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"  # Calculate the absolute path of the directory containing this script
...
# [2025-11-16 11:01:23] [INFO] Backup completed successfully
